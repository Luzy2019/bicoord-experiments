...
def get_args_parser():
    ...
    parser.add_argument("--asym_projector_mode", action="store", type=str, default="hold")
    ...
    parser.add_argument("--asym_schedule_mode", action="store", type=str, default="fixed")
    parser.add_argument("--asym_target_mode", action="store", type=str, default="projected")
