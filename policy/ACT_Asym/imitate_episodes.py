...
def main(args):
    ...
    # fixed parameters
    state_dim = args.get("action_dim", 14)  # yiheng
    lr_backbone = 1e-5
    backbone = "resnet18"
    if policy_class == "ACT":
        enc_layers = 4
        ...
        policy_config = {
            ...
            "use_asym_residual": args.get("use_asym_residual", False),
            "left_action_dim": args.get("left_action_dim", 7),
            "right_action_dim": args.get("right_action_dim", 7),
            "left_action_start": args.get("left_action_start", 0),
            "right_action_start": args.get("right_action_start", 7),
            "left_stride": args.get("left_stride", 1),
            "right_stride": args.get("right_stride", 1),
            "asym_hidden_dim": args.get("asym_hidden_dim", 256),
            "asym_residual_scale": args.get("asym_residual_scale", 0.1),
            "asym_projector_mode": args.get("asym_projector_mode", "hold"),
            "asym_strict_execution": args.get("asym_strict_execution", True),
            "asym_use_qpos_condition": args.get("asym_use_qpos_condition", True),
            "asym_schedule_mode": args.get("asym_schedule_mode", "fixed"),
            "asym_target_mode": args.get("asym_target_mode", "projected"),
...
def eval_bc(config, ckpt_name, save_episode=True):
    ...
    strict_load = not getattr(policy, "use_asym_residual", False)
    loading_status = policy.load_state_dict(torch.load(ckpt_path), strict=strict_load)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--use_asym_residual", action="store_true")
    parser.add_argument("--left_action_dim", action="store", type=int, default=7)
    parser.add_argument("--right_action_dim", action="store", type=int, default=7)
    parser.add_argument("--left_action_start", action="store", type=int, default=0)
    parser.add_argument("--right_action_start", action="store", type=int, default=7)
    parser.add_argument("--left_stride", action="store", type=int, default=1)
    parser.add_argument("--right_stride", action="store", type=int, default=1)
    parser.add_argument("--asym_hidden_dim", action="store", type=int, default=256)
    parser.add_argument("--asym_residual_scale", action="store", type=float, default=0.1)
    parser.add_argument("--asym_projector_mode", action="store", type=str, default="hold", choices=["hold", "none"])
    parser.add_argument("--asym_strict_execution", action="store_true", default=True)
    parser.add_argument("--asym_highfreq_residual", action="store_false", dest="asym_strict_execution")
    parser.add_argument("--asym_use_qpos_condition", action="store_true", default=True)
    parser.add_argument("--asym_no_qpos_condition", action="store_false", dest="asym_use_qpos_condition")
    parser.add_argument("--asym_schedule_mode", action="store", type=str, default="fixed", choices=["fixed", "learned"])
    parser.add_argument("--asym_target_mode", action="store", type=str, default="projected", choices=["projected", "original"])
    parser.add_argument("--asym_stride_choices", action="store", type=str, default="")
