...
class FactorizedBimanualDiffusionUnetImagePolicy(BaseImagePolicy):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.left_marginal_model = build_arm_unet(self.left_action_dim, global_cond_dim)
        self.right_marginal_model = build_arm_unet(self.right_action_dim, global_cond_dim)
    ...
    def _predict_factorized(
        ...
        left_marginal = self.left_marginal_model(left_noisy, timesteps, global_cond=global_cond)
        right_marginal = self.right_marginal_model(right_noisy, timesteps, global_cond=global_cond)
    ...
    def compute_loss(self, batch):
        ...
        aux_losses = [
            F.mse_loss(gate_info["left_marginal"], left_label),
            F.mse_loss(gate_info["right_marginal"], right_label),
            F.mse_loss(gate_info["left_cond"], left_label),
            F.mse_loss(gate_info["right_cond"], right_label),
        ]
