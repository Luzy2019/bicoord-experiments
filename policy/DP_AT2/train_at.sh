...
# Train the action-only coupling-scheduled Diffusion Policy with KL coupling.
#
# Usage:
...
config_name=${DP_AT_CONFIG_NAME:-robot_dp_at2_16}
...
exp_name="${task_name}-coupling_scheduled_dp_at2_kl"
...
echo -e "\033[33mDP_AT2 config: ${config_name}\033[0m"
