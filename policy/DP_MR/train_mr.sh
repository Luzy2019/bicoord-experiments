...
exp_name=${task_name}-robot_dp_mr-${addition_info}
...
stage_overrides=()
if [ "${stage}" = "teacher" ]; then
    stage_overrides+=("policy._target_=diffusion_policy.policy.diffusion_unet_image_policy.DiffusionUnetImagePolicy")
