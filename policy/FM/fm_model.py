...
from flow_matching_policy.workspace.robotworkspace import RobotWorkspace
from flow_matching_policy.env_runner.fm_runner import FMRunner

class FM:

    def __init__(self, ckpt_file: str):
        self.policy = self.get_policy(ckpt_file, None, "cuda:0")
        self.runner = FMRunner(output_dir=None)
