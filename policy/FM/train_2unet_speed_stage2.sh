...
# Stage 2: initialize from a stable 2-UNET Flow Matching base checkpoint, freeze base policy,
...
addition_info=2unet_fm_speed_stage2
exp_name=${task_name}-fm-${addition_info}

echo -e "\033[33mStage 2: freeze 2-UNET Flow Matching base, train SpeedHead only\033[0m"
