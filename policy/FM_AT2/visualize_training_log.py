...
PLOT_GROUPS = [
    (
        ...
        ["train_loss", "val_loss", "flow_matching_loss", "speed_modulation_loss"],
        False,
    ),
    (
        "02_flow_matching_losses",
        "Left/right flow matching losses",
        ["left_flow_matching_loss", "right_flow_matching_loss", "flow_matching_loss"],
        False,
    ),
    (
        "03_coupling_distribution_losses",
        "Coupling distribution NLL losses",
        [
            "coupling_aux_loss",
            "left_marginal_nll",
            "right_marginal_nll",
            "left_conditional_nll",
            "right_conditional_nll",
        ],
        False,
    ),
    (
    ...
    (
        "09_coupling_risk",
        "Coupling KL",
        ["coupling_kl_l_to_r", "coupling_kl_r_to_l"],
        False,
    ),
    (
        "10_train_action_mse",
