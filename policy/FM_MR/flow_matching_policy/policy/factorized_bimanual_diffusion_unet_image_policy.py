...
class FactorizedBimanualDiffusionUnetImagePolicy(BaseImagePolicy):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Kept for config/checkpoint compatibility; FM sampling integrates a
        # learned vector field directly instead of using DDPM scheduler steps.
    ...
    def compute_loss(self, batch):
        ...
        if self.speed_modulation_train_only:
            total_loss = flow_matching_loss * 0.0
        else:
