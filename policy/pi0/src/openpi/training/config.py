...
_CONFIGS = [
    ...
    # pi0_base by full rlbench
    TrainConfig(
        name="pi0_base_aloha_rlbench_full",
        model=pi0.Pi0Config(),
        data=LeRobotAlohaDataConfig(
            repo_id="rlbench_2",  # your datasets repo_id
            adapt_to_pi=False,
            repack_transforms=_transforms.Group(inputs=[
                _transforms.RepackTransform({
                    "images": {
    ...
    TrainConfig(
        ...
        model=pi0.Pi0Config(),
        data=LeRobotAlohaDataConfig(
            repo_id="heat_food",  # your datasets repo_id
            adapt_to_pi=False,
            repack_transforms=_transforms.Group(inputs=[
                _transforms.RepackTransform({
                    "images": {
